...
* **Automatic Mode:** "Quick Generate" valid schedules based on common patterns. You can **Pin** specific sections and rotate the rest.
    * It also come with advanced options that can provide the system an priority instructions, filtring or constraints (e.g., "No classes on Sundays" or "Breaks must be long") rather than relying on common patterns.  
